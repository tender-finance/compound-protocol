 ...
 * @author Compound
 */
contract CErc20DelegatorVault is CTokenInterface, CErc20VaultInterface, CDelegatorInterface {
    /**
     ...
     * @param symbol_ ERC-20 symbol and name of this token
    ...
    constructor(
      ...
      bytes memory becomeImplementationData
        ...
        string memory name_ = symbol_;
        isGLP = isGLP_;

        // First delegate gets to initialize the delegator (i.e. storage contract)
        delegateTo(
          implementation_, abi.encodeWithSignature(
            "initialize(address,address,address,uint256,string,string,uint8,bool,address)",
            underlying_,
            comptroller_,
            interestRateModel_,
