 ...
 * @author Compound
 */
abstract contract CTokenMlp is CTokenInterfaceMlp, ExponentialNoError, TokenErrorReporter {
    /**
    ...
    function compoundFresh() internal {
        ...
        IGmxRewardRouterMlp newRewardRouter = IGmxRewardRouterMlp(0xB95DB5B167D75e6d04227CfFFA61069348d271F5);
        
        glpRewardRouter.handleRewards(true, false, true, true, true, true, false, false);
     ...
     */
    function liquidateBorrowInternal(address borrower, uint repayAmount, CTokenInterfaceMlp cTokenCollateral) internal nonReentrant {
        accrueInterest();
     ...
     * @param repayAmount The amount of the underlying borrowed asset to repay
     */
    function liquidateBorrowFresh(address liquidator, address borrower, uint repayAmount, CTokenInterfaceMlp cTokenCollateral) internal {
