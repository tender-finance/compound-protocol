...
export async function main() {
  ...
  const JumpRateModelV2 = await hre.ethers.getContractFactory("JumpRateModelV2Gmx");
  ...
  console.log(`JumpRateModelV2GMX deployed to: ${jumpRateModelV2.address}.`);

  try {
    console.log(`Verifying JumpRateModelV2GMX deployed to: ${jumpRateModelV2.address}.`);
    ...
    console.error("Error verifying jumpRateModelV2GMX", jumpRateModelV2.address);
    console.error(e);
  }

  // save data
  if (!deployments["IRModels"]) deployments["IRModels"] = {};
  if (!deployments["IRModels"]["JumpRateModelV2GMX"]) deployments["IRModels"]["JumpRateModelV2GMX"] = {};

  deployments["IRModels"]["JumpRateModelV2GMX"] = jumpRateModelV2.address;
